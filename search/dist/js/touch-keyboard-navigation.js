...
(function () {
  ...
  function toggleSubmenuDisplay () {
    document.addEventListener('touchstart', function (event) {
      ...
      } else if (getCurrentParent(event.target, '.submenu-expand') != null &&
    ...
    document.addEventListener('touchend', function (event) {
      ...
      if (mainNav != null && hasClass(mainNav, '.main-navigation')) {
        ...
        event.target.matches('.submenu-expand') ||
				getCurrentParent(event.target, '.submenu-expand') != null &&
				getCurrentParent(event.target, '.submenu-expand').matches('.submenu-expand') ||
				event.target.matches('.menu-item-link-return') ||
				getCurrentParent(event.target, '.menu-item-link-return') != null &&
